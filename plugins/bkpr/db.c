...
static struct migration db_migrations[] = {
	...
	{SQL("CREATE TABLE accounts ("
		...
		", name VARCHAR(64)"
		", peer_id VARCHAR(64)"
		", opened_event_id BIGINT REFERENCES chain_events(id)"
		", closed_event_id BIGINT REFERENCES chain_events(id)"
	...
	{SQL("CREATE TABLE onchain_fees ("
		...
		");"),
	NULL},
	{SQL("ALTER TABLE chain_events ADD origin VARCHAR(64);"), NULL},
