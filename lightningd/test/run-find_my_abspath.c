...
/* Generated stub for watch_for_utxo_reconfirmation */
void watch_for_utxo_reconfirmation(struct chain_topology *topo UNNEEDED)
{ fprintf(stderr, "watch_for_utxo_reconfirmation called!\n"); abort(); }
